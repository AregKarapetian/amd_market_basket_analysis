...
\begin{itemize}
    ...
    Kaggle API, authenticated with \texttt{os.environ['KAGGLE\_USERNAME']} /
    \texttt{os.environ['KAGGLE\_KEY']} set inside the notebook. The
    distributed version of the notebook contains placeholder values
    (\texttt{"xxxxxx"}); reproducing the experiments requires a Kaggle
    account and replacing the placeholders with a real username and API key
